					...
					<div class="row mt-lg-5 mt-3">
						<div class="col-md-3 team-main-gd">
							<div class="team-grid text-center">
								...
								<div class="team-img">
									<img class="img-fluid rounded" src="../images/sandesh.jpg" style="width:400px;height:400px;" >
								</div>
								<div class="team-info">
					 ...
					 <div class="col-md-3 team-main-gd">
							<div class="team-grid text-center">
								...
								<div class="team-img">
									<img class="img-fluid rounded" src="../images/srijan.jpg" style="width:400px;height:400px;">
								</div>
								<div class="team-info">
									...
									<ul class="d-flex justify-content-center py-3 social-icons">
										<li>
											<a href="https://www.facebook.com/s1r2i3">
												<i class="fab fa-facebook-f"></i>
											</a>
										</li>
										<li class="mx-3">
						...
						<div class="col-md-3 team-main-gd">
							<div class="team-grid text-center">
								...
								<div class="team-img">
									<img class="img-fluid rounded" src="../images/bijay.jpg" style="width:400px;height:400px;">
								</div>
								<div class="team-info">
									<h4>Bijay Rajak</h4>
									<span>Description </span>
									<ul class="d-flex justify-content-center py-3 social-icons">
										<li>
											<a href="https://www.facebook.com/bijay.rajak.104">
												<i class="fab fa-facebook-f"></i>
											</a>
										</li>
										<li class="mx-3">
						...
						<div class="col-md-3 team-main-gd">
							<div class="team-grid text-center">
								...
								<div class="team-img">
									<img class="img-fluid rounded" src="../images/Arpan.jpg" style="width:400px;height:400px;">
								</div>
								<div class="team-info">
									<h4>Arpan Limbu</h4>
									<span>Description </span>
									<ul class="d-flex justify-content-center py-3 social-icons">
										<li>
											<a href="https://www.facebook.com/arpan.limbu.969">
												<i class="fab fa-facebook-f"></i>
											</a>
										</li>
										<li class="mx-3">
