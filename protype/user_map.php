...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
   ...
   <script type="text/javascript"
            src="https://maps.googleapis.com/maps/api/js?language=en&key=AIzaSyBISQUK7ltRgWLOhmn_9iAInDNP4cQpmr0">
    </script>
    ...
    <script>
        ...
        var myOptions = {
            zoom: 20,
            center: new google.maps.LatLng(27.695953,85.334870),
            mapTypeId: 'roadmap'
        };
        ...
        function saveData(lat,lng) {
            ...
            var CId = "<?php echo $_GET['c_id'];?>";
            var url = 'locations_model.php?add_location&description=' + description + '&lat=' + lat + '&lng=' + lng + '&c_id =' + CId;
